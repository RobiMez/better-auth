					...
					<div className="md:col-span-10 flex items-center justify-end relative">
						<ul className="md:flex items-center divide-x w-max hidden shrink-0">
							...
							<NavLink
								...
								className=" bg-muted/20 divide-x"
								external
							>
								<svg
						...
						<li className="relative group hidden md:block">
							<button
								...
								className={cn(
									"w-full h-full flex items-center gap-2 py-4 px-5 transition-colors",
									"group-hover:text-foreground",
									isAIChatOpen ? "text-foreground" : "text-muted-foreground",
								)}
							>
							...
							<div
								className={cn(
									...
									isAIChatOpen ? "opacity-100 w-full" : "w-0",
								)}
							/>
						</li>
						<ThemeToggle />
